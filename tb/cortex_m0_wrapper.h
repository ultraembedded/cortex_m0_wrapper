...
#ifndef CORTEX_M0_WRAPPER_H
#define CORTEX_M0_WRAPPER_H
#include <systemc.h>

#include "axi4.h"
#include "axi4.h"

class Vcortex_m0_wrapper;
class VerilatedVcdSc;

//-------------------------------------------------------------
// cortex_m0_wrapper: RTL wrapper class
//-------------------------------------------------------------
class cortex_m0_wrapper: public sc_module
{
public:
    sc_in <bool> clk_in;
    sc_in <bool> rst_in;
    ...
    // Constructor
    //-------------------------------------------------------------
    SC_HAS_PROCESS(cortex_m0_wrapper);
    cortex_m0_wrapper(sc_module_name name);
