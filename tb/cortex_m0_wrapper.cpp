...
// Constructor
//-------------------------------------------------------------
cortex_m0_wrapper::cortex_m0_wrapper(sc_module_name name): sc_module(name)
{
    m_rtl = new Vcortex_m0_wrapper("Vcortex_m0_wrapper");
...
// trace_enable
//-------------------------------------------------------------
void cortex_m0_wrapper::trace_enable(VerilatedVcdSc * p)
{
#if VM_TRACE
    m_vcd = p;
...
void cortex_m0_wrapper::trace_enable(VerilatedVcdSc *p, sc_core::sc_time start_time)
{
#if VM_TRACE
    m_vcd = p;
    m_delay_waves = true;
...
// async_outputs
//-------------------------------------------------------------
void cortex_m0_wrapper::async_outputs(void)
{
